...
class PayslipEarningDetailAdapter (private var payslipArrayList: ArrayList<Payslip>): RecyclerView.Adapter<PayslipEarningDetailAdapter.PayslipDetailViewHolder>() {
